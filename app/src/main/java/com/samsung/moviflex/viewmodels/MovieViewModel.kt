...
import com.samsung.moviflex.repositories.MovieRepository
...
class MovieViewModel @Inject constructor(private val movieRepository: MovieRepository) :
    ...
    fun similarMovies(movieId: Int) = movieRepository.getSimilarMovies(movieId).cachedIn(viewModelScope)
