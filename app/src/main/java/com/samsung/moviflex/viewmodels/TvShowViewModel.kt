package com.samsung.moviflex.viewmodels
...
import com.samsung.moviflex.repositories.TvShowRepository
...
class TvShowViewModel @Inject constructor(private val tvShowRepository: TvShowRepository) :
    ...
    fun similarTvShow(tvShowId: Int) = tvShowRepository.getSimilarTvShow(tvShowId).cachedIn(viewModelScope)
