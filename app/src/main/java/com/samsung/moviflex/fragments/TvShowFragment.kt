...
import com.samsung.moviflex.adapters.MovieAdapter
import com.samsung.moviflex.adapters.SliderAdapter
import com.samsung.moviflex.R
import com.samsung.moviflex.viewmodels.TvShowViewModel
import com.samsung.moviflex.databinding.FragmentTvShowBinding
    ...
    private fun bindUI() {
        binding.apply {
            ...
            popularButton.setOnClickListener {
                val action = TvShowFragmentDirections.actionTvShowFragmentToViewAllFragment(getString(R.string.popular_tv_shows))
                findNavController().navigate(action)
            }

            topRatedButton.setOnClickListener {
                val action = TvShowFragmentDirections.actionTvShowFragmentToViewAllFragment(getString(R.string.top_rated_tv_shows))
                findNavController().navigate(action)
            }

            onTheAirButton.setOnClickListener {
                val action = TvShowFragmentDirections.actionTvShowFragmentToViewAllFragment(getString(R.string.on_the_air_tv_shows))
                findNavController().navigate(action)
            }
        }
