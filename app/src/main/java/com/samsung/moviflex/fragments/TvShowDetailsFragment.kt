...
import com.samsung.moviflex.adapters.SeasonAdapter
import com.samsung.moviflex.api.MovieApi
import com.samsung.moviflex.databinding.FragmentTvshowDetailsBinding
    ...
    private fun bindWithUi(tvShowDetails: TvShowDetails) {
        ...
        binding.apply {
            ...
            Glide.with(this@TvShowDetailsFragment)
                .load(MovieApi.url(tvShowDetails.posterPath))
            ...
            playVideo.setOnClickListener {
                val action = TvShowDetailsFragmentDirections.actionTvShowDetailsFragmentToVideoActivity(key)
