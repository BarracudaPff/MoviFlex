...
import com.samsung.moviflex.viewmodels.MovieViewModel
import com.samsung.moviflex.databinding.FragmentMovieBinding
    ...
    private fun bindUI() {
        binding.apply {
            ...
            popularButton.setOnClickListener {
                val action = MovieFragmentDirections.actionHomeFragmentToViewAllFragment(getString(R.string.popular_movies))
                findNavController().navigate(action)
            }

            topRatedButton.setOnClickListener {
                val action = MovieFragmentDirections.actionHomeFragmentToViewAllFragment(getString(R.string.top_rated_movies))
                findNavController().navigate(action)
            }

            upcomingButton.setOnClickListener {
                val action = MovieFragmentDirections.actionHomeFragmentToViewAllFragment(getString(R.string.upcoming_movies))
                findNavController().navigate(action)
            }
        }
