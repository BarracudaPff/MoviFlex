...
import com.samsung.moviflex.databinding.FragmentMovieDetailsBinding
import com.samsung.moviflex.models.MovieDetails
...
class MovieDetailsFragment : Fragment() {
    ...
    private fun bindWithUi(movieDetails: MovieDetails) {
        binding.apply {
            ...
            Glide.with(this@MovieDetailsFragment)
                .load(MovieApi.PHOTO_BASE_URL + movieDetails.posterPath)
            ...
            playVideo.setOnClickListener {
                val action = MovieDetailsFragmentDirections.actionMovieDetailsFragmentToVideoActivity(key)
    ...
    private fun showData() = binding.apply {
