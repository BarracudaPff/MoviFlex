...
import com.samsung.moviflex.paginations.MovieLoadStateAdapter
...
import com.samsung.moviflex.databinding.FragmentViewAllBinding
...
class ViewAllFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (
            args.type == getString(R.string.popular_movies)
            || args.type == getString(R.string.top_rated_movies)
            || args.type == getString(R.string.upcoming_movies)
        ) {
