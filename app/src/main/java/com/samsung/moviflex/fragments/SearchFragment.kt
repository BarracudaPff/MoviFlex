...
import com.samsung.moviflex.adapters.GenreAdapter
import com.samsung.moviflex.adapters.SecondMovieAdapter
...
import com.samsung.moviflex.databinding.FragmentSearchBinding
import com.samsung.moviflex.models.movieGenres
import com.samsung.moviflex.models.tvShowGenres
            ...
            editText.setOnEditorActionListener { _, actionId, _ ->
                ...
                if (actionId == EditorInfo.IME_ACTION_SEARCH) {
                    tvShowViewModel.apply {
                        tvShowViewModel.search(editText.text.toString().trim()).observe(viewLifecycleOwner) {
            ...
            tvShowsGenreRecyclerView.apply {
                ...
                addItemDecoration(object : RecyclerView.ItemDecoration() {
                    override fun getItemOffsets(
                        ...
                        val position = parent.getChildAdapterPosition(view)
                        outRect.left = if (position % 2 == 0) 0 else 10
                        outRect.right = if (position % 2 == 0) 10 else 0
                        outRect.bottom = 20
                        if (position == 0 || position == 1) {
                            outRect.top = 20
                        }
